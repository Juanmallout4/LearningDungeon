        ...
        try {
            const response = await fetch('/api/register', {
                ...
                body: JSON.stringify({
                    ...
                    adRemoval: false, // Default on registration
                    belt: 'Blanco (10º Gup)'
                }),
            });
            ...
            if (!response.ok) {
                // Handle specific API errors like duplicate email
            ...
            if (Platform.OS === 'web') {
                // On web, native alerts block the thread and can break React Navigation.
            ...
            return; // Exit early so the finally block doesn't set loading to false again needlessly
        } catch (error: any) {
...
const createStyles = (theme: AppTheme) => StyleSheet.create({
    ...
    countryPickerButton: {
        ...
        borderRadius: theme.borderRadius.m,
        paddingHorizontal: theme.spacing.m,
        height: 52, // Match typical TextInput height
        gap: 6,
    },
    countryFlag: {
        fontSize: 18,
